package com.pryde.prydecrudd.funcionario.controller;

import com.pryde.prydecrudd.funcionario.entity.Funcionario;
import com.pryde.prydecrudd.funcionario.serviceimpl.FuncionarioServiceImplements;
...
public class FuncionarioController {
    ...
    @PostMapping(path = "/salvarFuncionarioCadastro")
    public @ResponseBody
    ...
    @PutMapping(path = "/atualizarFuncionario")
    public @ResponseBody
    ...
    @DeleteMapping(path = "/deletarCadastroFuncionario")
    public @ResponseBody
    ...
    @GetMapping(path = "/buscarCadastroFuncionario")
